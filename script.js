...
$("#submit-btn").click(function() {
    ...
    if (isEmail($("#email").val()) == false) {
        errorMessage +=  "Please enter a valid email address";                           // THE += OPERATOR APPENDS THE ASSIGNED STRING VALUE TO THE END OF THE CONTENTS OF errorMessage
    };   // BY DEFAULT, THE CHECK WILL BE TRUE. HERE, THIS IS CHANGED TO ACTION A COMMAND IF IT IS FALSE - THIS IS OF PARTICULAR INTEREST
    alert(errorMessage);
});
